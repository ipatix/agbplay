...
void Rom::Verify()
{
    ...
    static const std::array<uint8_t, 156> imageBytes{
...
{
    return FileReader::forRaw(filePath, [this](FileReader &fileReader) { return LoadGsflib(fileReader); });
}
...
{
    return FileReader::forRaw(filePath, [this](FileReader &fileReader) { return LoadRaw(fileReader); });
}
